...
export function MethodologyProductSurface(): ReactNode {
  return (
    <MethodologySection
      ...
      description="Методология связана с рабочими экранами продукта: главная даёт обзор, каталог помогает сравнивать SKU, карточка объясняет решение по конкретной позиции."
    >
